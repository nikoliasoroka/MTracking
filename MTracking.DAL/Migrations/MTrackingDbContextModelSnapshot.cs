...
namespace MTracking.DAL.Migrations
{
    ...
    partial class MTrackingDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTracking.Core.Entities.UserFilePin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MTracking.Core.Entities.UserFilePin", b =>
                {
                    b.HasOne("MTracking.Core.Entities.File", null)
                        .WithMany("UserFilePins")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
